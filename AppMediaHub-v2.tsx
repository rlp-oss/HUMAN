...
export const AppMediaHub: React.FC = () => {
  // 1. Data Definitions
  ...
  const renderLogoSVG = (type: 'book' | 'node' | 'gear' | 'flow', color: string) => {
    switch (type) {
      case 'book':
  ...
  return (
    <div className="min-h-screen bg-[#070A11] text-[#F8FAFC] font-sans selection:bg-emerald-500 selection:text-black">
      
      {/* 1. Header/Navigation */}
      <header className="border-b border-[#1E293B] bg-[#070A11]/80 backdrop-blur-md sticky top-0 z-50">
        <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
          <div className="flex items-center space-x-3">
            ...
            <div>
              <h1 className="font-bold text-lg tracking-wider text-[#F8FAFC]">THE H.U.M.A.N. INITIATIVE</h1>
              <span className="text-xs text-emerald-500 tracking-widest font-mono uppercase">App & Broadcast Hub</span>
            </div>
          </div>
          <div className="flex items-center space-x-6">
            <span className="text-sm font-mono text-[#94A3B8] bg-[#0F172A] px-3 py-1.5 rounded-md border border-[#1E293B]">
            ...
            <a 
              ...
              target="_blank" 
              rel="noreferrer"
              className="flex items-center space-x-1.5 text-xs text-[#F8FAFC] font-mono bg-emerald-500 hover:bg-emerald-400 text-slate-950 px-4 py-2.5 rounded-md font-bold transition-all transform hover:-translate-y-0.5 shadow-lg shadow-emerald-500/20"
            >
      ...
      {/* 2. Hero Section */}
      <section className="relative overflow-hidden py-16 px-6 border-b border-[#1E293B] bg-[radial-gradient(ellipse_at_top,_var(--tw-gradient-stops))] from-slate-900 via-slate-950 to-slate-950">
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          <div className="lg:col-span-7 space-y-6">
            ...
            <h2 className="text-4xl lg:text-5xl font-extrabold tracking-tight leading-none text-[#F8FAFC]">
            ...
            <p className="text-lg text-[#94A3B8] leading-relaxed max-w-2xl">
              Technology should be our symbiotic partner, never our replacement. Dive into our complete podcast fleet featuring comprehensive insights, application architectures, and the revolutionary <strong className="text-[#F8FAFC]">H.U.M.A.N. SDK integration pipeline</strong>—designed to restore creator trust and fund regional human survival.
            </p>
            <div className="flex flex-wrap gap-4 pt-2">
              <div className="flex items-center space-x-2.5 bg-[#0F172A]/50 border border-[#1E293B] p-3 rounded-lg">
                <Users className="w-5 h-5 text-emerald-400" />
                <div className="text-left">
                  <div className="text-xs text-[#94A3B8] font-mono">Registry Pool</div>
                  <div className="text-sm font-bold text-[#F8FAFC]">100% Non-Profit</div>
                </div>
              </div>
              <div className="flex items-center space-x-2.5 bg-[#0F172A]/50 border border-[#1E293B] p-3 rounded-lg">
                <Heart className="w-5 h-5 text-cyan-400" />
                <div className="text-left">
                  <div className="text-xs text-[#94A3B8] font-mono">Society Split</div>
                  <div className="text-sm font-bold text-[#F8FAFC]">50% Real-Time Escrow</div>
                </div>
              </div>
              <div className="flex items-center space-x-2.5 bg-[#0F172A]/50 border border-[#1E293B] p-3 rounded-lg">
                <Lock className="w-5 h-5 text-blue-400" />
                <div className="text-left">
                  <div className="text-xs text-[#94A3B8] font-mono">Data Policy</div>
                  <div className="text-sm font-bold text-[#F8FAFC]">Zero-Ingestion</div>
                </div>
              </div>
            </div>
          </div>
          <div className="lg:col-span-5 bg-[#0F172A]/30 border border-[#1E293B] p-6 rounded-2xl relative">
            ...
            <div className="space-y-4">
              ...
              <div>
                <h3 className="text-xl font-bold tracking-tight text-[#F8FAFC] line-clamp-2">{activeEpisode.title}</h3>
                <span className="text-xs text-[#94A3B8] mt-1 block">Duration: {activeEpisode.duration} • Category: {activeEpisode.category}</span>
              </div>
              ...
              <div className="space-y-2 pt-4">
                ...
                <div className="flex items-end justify-between h-10 px-2 bg-[#070A11]/60 rounded-lg border border-[#1E293B]/60 py-1.5 space-x-0.5">
              ...
              <div className="flex items-center justify-between pt-4">
                <div className="flex items-center space-x-4">
                  <button 
                    ...
                    className="w-12 h-12 bg-emerald-500 hover:bg-emerald-400 text-slate-950 rounded-full flex items-center justify-center font-bold transition-all transform active:scale-95 shadow-md shadow-emerald-500/20"
                  >
                ...
                <button 
                  ...
                  className="p-2 border border-[#1E293B] hover:border-slate-700 hover:bg-[#0F172A] rounded-lg text-[#94A3B8] hover:text-slate-200 transition-all"
                  title="Share Episode"
                >
      ...
      <main className="max-w-7xl mx-auto px-6 py-16 grid grid-cols-1 lg:grid-cols-12 gap-12">
        ...
        <section className="lg:col-span-7 space-y-8">
          <div className="border-b border-[#1E293B] pb-4">
            <h3 className="text-2xl font-bold tracking-tight text-[#F8FAFC] flex items-center space-x-2">
              <span className="w-2.5 h-2.5 bg-emerald-500 rounded-full" />
              <span>THE BROADCAST MATRIX</span>
            </h3>
            <p className="text-sm text-[#94A3B8] mt-1">Select an episode to populate the control studio and inspect deep takeaways.</p>
          </div>
            ...
            {episodes.map((ep) => {
              ...
              return (
                <div 
                  ...
                  className={`border p-5 rounded-xl transition-all duration-300 cursor-pointer text-left relative ${isSelected ? 'bg-[#0F172A]/60 border-emerald-500/40 shadow-lg shadow-emerald-500/5' : 'bg-[#070A11]/40 border-[#1E293B] hover:bg-[#0F172A]/20 hover:border-[#1E293B]'}`}
                >
                  {isSelected && (
                  ...
                  <div className="flex items-center space-x-2.5 mb-2">
                    <span className={`text-[10px] font-mono uppercase px-2 py-0.5 rounded ${ep.category === 'Protocol' ? 'bg-emerald-500/10 text-emerald-400' : ep.category === 'Engineering' ? 'bg-cyan-500/10 text-cyan-400' : 'bg-emerald-500/10 text-emerald-400'}`}>
                      {ep.category}
                    </span>
                    <span className="text-xs font-mono text-[#94A3B8]">{ep.duration} mins</span>
                  </div>
                  <h4 className={`text-lg font-bold tracking-tight transition-colors ${isSelected ? 'text-emerald-400' : 'text-[#F8FAFC]'}`}>
                    {ep.title}
                  </h4>
                  <p className="text-sm text-[#94A3B8] line-clamp-2 mt-2 leading-relaxed">
                    {ep.introduction}
                  </p>
                  
                  {isSelected && (
                    <div className="mt-4 pt-4 border-t border-[#1E293B] space-y-3">
                      <div className="text-xs font-bold text-[#F8FAFC] font-mono tracking-wider uppercase">Key Takeaways from the episode:</div>
                      <ul className="space-y-2">
                        {ep.keyTakeaways.map((takeaway, index) => (
                          <li key={index} className="flex items-start text-xs text-[#94A3B8] space-x-2">
        ...
        <section className="lg:col-span-5 space-y-8">
          <div className="border-b border-[#1E293B] pb-4">
            ...
            <p className="text-sm text-[#94A3B8] mt-1">Live subdomains deployed and secured under Fairly Trained 2026 guidelines.</p>
          </div>
          ...
          <div className="grid grid-cols-1 gap-6">
            {apps.map((app) => (
              <div 
                key={app.id} 
                className="bg-[#070A11] border border-[#1E293B] rounded-2xl p-6 transition-all duration-300 hover:border-[#1E293B] flex flex-col justify-between"
              ...
              >
                <div>
                  <div className="flex items-center justify-between mb-4">
                    ...
                    <div className="text-right">
                      <span className="text-[10px] font-mono text-[#94A3B8] tracking-wider uppercase block">System Registration ID</span>
                      <span className="text-xs font-bold font-mono text-emerald-400 tracking-tight">{app.systemId}</span>
                    </div>
                  </div>
                  
                  <div className="space-y-1.5">
                    <h4 className="text-xl font-bold tracking-tight text-[#F8FAFC]">{app.name}</h4>
                ...
                <div className="mt-6 pt-4 border-t border-[#1E293B] flex items-center justify-between">
                  <span className="text-[10px] font-mono uppercase tracking-wider bg-[#0F172A] text-[#94A3B8] px-2 py-1 rounded border border-slate-850">
                    {app.licenseStandard}
                  </span>
                  <a 
                    href={app.url} 
                    target="_blank" 
                    rel="noreferrer"
                    className="flex items-center space-x-1 text-xs text-[#F8FAFC] hover:text-emerald-400 font-mono tracking-tight font-bold transition-colors"
                  >
      ...
      <section className="bg-[radial-gradient(ellipse_at_bottom,_var(--tw-gradient-stops))] from-slate-900/60 via-slate-950 to-slate-950 border-t border-[#1E293B] py-16 px-6">
        <div className="max-w-4xl mx-auto text-center space-y-6">
          ...
          <h2 className="text-3xl lg:text-4xl font-extrabold tracking-tight text-[#F8FAFC]">
          ...
          <div className="bg-[#070A11] border border-[#1E293B] p-6 rounded-2xl max-w-xl mx-auto text-left space-y-4">
            <div className="flex items-center justify-between border-b border-[#1E293B] pb-3">
              <span className="text-xs font-mono text-emerald-500 tracking-wider">Generated Initialisation Preview</span>
              <span className="text-[10px] font-mono text-[#94A3B8]">TypeScript / React</span>
            </div>
            <pre className="text-xs font-mono text-emerald-400 overflow-x-auto p-3 bg-[#070A11] rounded-lg leading-relaxed">
...
await sdk.initialize();`}
            ...
            <div className="text-xs text-[#94A3B8] leading-relaxed text-center">
          ...
          <div className="pt-4">
            <a 
              ...
              target="_blank" 
              rel="noreferrer"
              className="inline-flex items-center space-x-1.5 bg-[#0F172A] border border-[#1E293B] hover:border-slate-700 text-slate-200 hover:text-[#F8FAFC] px-6 py-3 rounded-lg font-mono text-sm font-bold transition-all transform hover:-translate-y-0.5"
            >
      ...
      {/* 5. Footer */}
      <footer className="border-t border-[#1E293B] bg-[#070A11] py-12 px-6 text-[#94A3B8] text-sm">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-6">
          <div className="flex items-center space-x-3">
            <div className="bg-[#0F172A] p-1.5 rounded-md border border-[#1E293B]">
              <Compass className="w-4 h-4 text-emerald-500" />
            </div>
            <span className="font-mono text-xs tracking-widest text-[#94A3B8]">THE H.U.M.A.N. PROTOCOL FOUNDATION</span>
          </div>
          <div className="flex flex-wrap gap-x-6 gap-y-2 text-xs">
            <a href="https://human-ethical-ai.ai.studio" className="hover:text-[#F8FAFC] transition-colors">Onboarding</a>
            <span>•</span>
